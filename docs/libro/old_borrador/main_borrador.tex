...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\Large FACULTAD POLITÉCNICA\par}
    \vspace{0.5cm}
    ...
    {\Large\itshape González Zarza, Luhana Araceli\par}
    {\Large\itshape Ruiz Díaz Nodari, Alan Mathías\par}
    
    \vfill
    
    {\large Tesis presentada como requisito para optar al título de\\
    [Ingeniería en Informática]\par}
